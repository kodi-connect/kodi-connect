...
async function changeStateHandler(username: string, deviceId: string, data: Object) {
...
export default async function asyncMessageHandler(username: string, deviceId: string, data: Object) {
  const { type, ...restData } = data;

  let handler: (username: string, deviceId: string, data: Object) => any;
