...
describe('Search and Play', () => {
  test('play-comedy-mean-girls', () => {
    ...
    ;['mediaType', 'season', 'episode'].forEach(key => expect(filter[key]).toBeNull())
  })
  ...
  test('play-comedy-with-tom-hanks', () => {
    ...
    ;['titles', 'collections', 'roles'].forEach(key => expect(filter[key]).toEqual([]))
    ;['mediaType', 'season', 'episode'].forEach(key => expect(filter[key]).toBeNull())
  })
  ...
  test('play-darth-vader-movies', () => {
    ...
    ;['titles', 'collections', 'genres', 'actors'].forEach(key => expect(filter[key]).toEqual([]))
  ...
  test('play-how-i-met-your-mother', () => {
    ...
    expect(filter.titles).toEqual([
      'How I Met Your Mother',
      'Goodbye How I Met Your Mother',
      'How I Met Your Mother: Extras',
      'How I Met Your Puppet Mother',
    ])
    ;['collections', 'genres', 'actors', 'roles'].forEach(key => expect(filter[key]).toEqual([]))
    ;['mediaType', 'season', 'episode'].forEach(key => expect(filter[key]).toBeNull())
  })
  ...
  test('play-mean-girls-with-lindsay-lohan', () => {
    ...
    ;['collections', 'genres', 'roles'].forEach(key => expect(filter[key]).toEqual([]))
    ;['mediaType', 'season', 'episode'].forEach(key => expect(filter[key]).toBeNull())
  })
  ...
  test('play-thor-with-chris-hemsworth', () => {
    ...
    ;['titles', 'genres', 'roles'].forEach(key => expect(filter[key]).toEqual([]))
    ;['mediaType', 'season', 'episode'].forEach(key => expect(filter[key]).toBeNull())
  })
  ...
  test('watch-jason-statham', () => {
    ...
    ;['titles', 'collections', 'genres', 'roles'].forEach(key => expect(filter[key]).toEqual([]))
    ;['mediaType', 'season', 'episode'].forEach(key => expect(filter[key]).toBeNull())
  })
  ...
  test('watch-season-2-episode-7-of-how-i-met-your-mother', () => {
    ...
    ;['mediaType'].forEach(key => expect(filter[key]).toBeNull())
  })
})
