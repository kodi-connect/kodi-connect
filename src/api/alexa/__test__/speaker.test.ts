...
describe('Speaker', () => {
  test('set volume', async () => {
    ...
    expect(kodiRpcCommandSpy).toHaveBeenCalledWith({}, 'testuser', 'device-001', 'setVolume', {
      volume: 50,
    })
  })
  ...
  test('adjust volume', async () => {
    ...
    expect(kodiRpcCommandSpy).toHaveBeenCalledWith({}, 'testuser', 'device-001', 'adjustVolume', {
      volume: -20,
    })
  })
  ...
  test('set mute', async () => {
    ...
    expect(kodiRpcCommandSpy).toHaveBeenCalledWith({}, 'testuser', 'device-001', 'setMute', {
      mute: true,
    })
  })
})
